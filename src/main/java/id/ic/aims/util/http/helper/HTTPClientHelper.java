package id.ic.aims.util.http.helper;

import java.util.List;
import java.util.stream.Collectors;

import id.ic.aims.util.http.model.HTTPHeader;
import id.ic.aims.util.http.model.HTTPParameter;
import id.ic.aims.util.http.model.HTTPRequest;
